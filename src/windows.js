...
const TRAY_H = 28;   // GNOME top bar (matches style.css .topbar)
const SHELF_H = 0;   // no bottom shelf — the dock is on the left
const DOCK_W = 72;   // left Ubuntu dock (matches style.css .dock)
const MIN_W = 280;
const MIN_H = 180;
...
function workspaceRect() {
  return {
    x: DOCK_W,                               // reserve the left dock
    y: TRAY_H,
    w: window.innerWidth - DOCK_W,
